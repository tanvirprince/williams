...
<div class="container col-md-8">
    @if (!$management)
    <form action="{{ route('management2.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
    ...
    @else
    <form action="{{ route('management3.update', $management->id)}}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="form-group">
          <label for="name">Name</label>
