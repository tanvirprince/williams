<header class="page_header header_darkgrey dark  header_white header_v1 toggler_xxs_right">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12 display-flex v-center">
                <div class="header_left_logo"> <a href="{{ route('homepage') }}" class="logo">
                        <img src="{{ asset('/') }}frontend/images/logo11.png" alt="Williams Sweaters Ltd">
                    </a> </div>
